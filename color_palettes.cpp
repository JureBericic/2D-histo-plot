                   ...
                   int& no_colors)
{
    for (int i=0; i<no_colors; i++)
    {
        ...
        else if (x<0.56)
        {
            reds.at(i) = 0;
            greens.at(i) = 1;
            blues.at(i) = -4.348*x + 2.435;
        }
        else if (x<0.78)
        {
            reds.at(i) = 4.545*x - 2.545;
            greens.at(i) = 1;
            blues.at(i) = 0;
        }
        else
                   ...
                   int& no_colors)
{
    for (int i=0; i<no_colors; i++)
    {
        ...
        {
            reds.at(i) = 1;
            greens.at(i) = 2.94118*x-0.970588;
            blues.at(i) = 0;
        }
        else
        {
                       ...
                       int& no_colors)
{
    for (int i=0; i<no_colors; i++)
    {
        ...
        if (x<0.33)
        {
            reds.at(i) = 1;
            greens.at(i) = 1;
            blues.at(i) = 1-3.0303*x;
        }
        else if (x<0.67)
        {
            reds.at(i) = 1;
            greens.at(i) = 1.97059-2.94118*x;
            blues.at(i) = 0;
        }
        else
        {
            reds.at(i) = 3.0303-3.0303*x;
            greens.at(i) = 0;
            blues.at(i) = 0;
        }
    }
