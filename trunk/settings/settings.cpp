...
namespace settings
{
    ...
    void change_settings()
    {
        ...
        while (read_settings)
        {
            ...
            {
                case 1:
                    std::cout << "val: "; std::cin >> display_color_scale;
                    break;
                case 2:
                    std::cout << "val: "; std::cin >> display_border;
                    break;
                case 3:
                    std::cout << "val: "; std::cin >> display_title;
                    break;
                case 4:
                    std::cout << "val: "; std::cin >> display_label;
                    break;
                case 5:
                    std::cout << "val: "; std::cin >> display_axis;
                    break;
                case 6:
                    std::cout << "val: "; std::cin >> display_scale;
                    break;
                case 7:
                    std::cout << "val: "; std::cin >> title_size;
                    break;
                case 8:
                    std::cout << "val: "; std::cin >> label_size;
                    break;
                case 9:
                    std::cout << "val: "; std::cin >> axis_size;
                    break;
                case 10:
                    std::cout << "val: "; std::cin >> plot_size_x;
                    break;
                case 11:
                    std::cout << "val: "; std::cin >> plot_size_y;
                    break;
                case 12:
                    std::cout << "val: "; std::cin >> color_palette_width;
                    break;
                case 13:
                    std::cout << "val: "; std::cin >> color_palette_margin;
                    break;
                case 14:
                    std::cout << "  1 -> min/max from data" << std::endl;
                    std::cout << "  2 -> user defined range" << std::endl;
                    std::cout << "  num: "; std::cin >> scale_range_type;
                    if (scale_range_type==2)
                    {
                        std::cout << "  min max: "; std::cin >> scale_min >> scale_max;
                    }
                    break;
